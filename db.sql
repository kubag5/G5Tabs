...
--
-- Host: 127.0.0.1
-- Czas generowania: 06 Lut 2024, 19:46
...
INSERT INTO `styles` (`id`, `id_u`, `hex1`, `hex2`, `hex3`) VALUES
(1, 2, '#090101', '#391212', '#d02d2d');
...
(8, 2, '{\"name\": \"Nowy Tab\", \"type\": 1, \"daty\": [{\"text\": \"przykladowy box\", \"data\": \"1 STY 2024\"}]}');
